var stateData = {
	...
	vinci: {
		...
		nationality: 'Republic of Florence (present-day  Italy)',
		knownFor: 'Art (painting, drawing, sculpting), science, engineering, architecture, anatomy',
		movement: ' High Renaissance',
		notableWork: 'Mona Lisa,The Last Supper,Lady with an Ermine Virgin of the Rocks',
	...
	michelangelo: {
		...
		born: '6 March 1475',
		nationality: 'Republic of Florence (present-day Tuscany, Italy)',
		knownFor: 'Sculpture, painting, architecture, and poetry',
		movement: ' High Renaissance',
		notableWork: 'David, Moses,The Last Judgment ,Sistine Chapel ceiling.',
		died: '18 February 1564 (aged 88)Rome, (present-day Italy)',
	},
	md: {
		name: 'Maryland',
		abbr: 'MD',
	...
	cezanne: {
		...
		notableWork: 'The Card Players (1890–1895),The Bathers (1898–1905)',
	...
	rembrant: {
		...
		born: '15 July 1606',
		nationality: ', Dutch Republic (now the Netherlands)',
		knownFor: 'Painting',
